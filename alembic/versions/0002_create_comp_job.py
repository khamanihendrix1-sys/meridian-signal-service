...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("status", sa.Enum("PENDING", "RUNNING", "SUCCESS", "FAILED", name="compjobstatus"), nullable=False),
        sa.Column("comp_ids", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
