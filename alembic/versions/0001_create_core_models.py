...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "property_type",
            sa.Enum(
                "SFR", "CONDO", "TOWNHOUSE", "MULTIFAMILY", "LAND", name="propertytype"
            ),
            nullable=False,
        ),
        ...
        sa.Column(
            "raw", sa.JSON(), nullable=False, server_default=sa.text("'{}'::json")
        ),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "category",
            sa.Enum(
                "PRICE", "INVENTORY", "VELOCITY", "ABSORPTION", name="signalcategory"
            ),
            nullable=False,
        ),
